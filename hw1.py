...
def client():
    ...
    sock.bind(('127.0.0.1', port_client))
    while True:
        DiscoverPacket=DHCP_Discover()
        sock.sendto(DiscoverPacket.buildPacket(), ('127.0.0.1', port_server))
        data, address = sock.recvfrom(MAX_BYTES)
